...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class PostProcessRenderContext
    {
        ...
        /// <summary>
        /// A reference to the AASR settings for the rendering layer.
        /// </summary>
        public AASR aasr
        {
            get; internal set;
        ...
        {
            if (antialiasing == PostProcessLayer.Antialiasing.SGSR)
            {
#if TND_SGSR
                return sgsr.UnityTAAEnabled && !isSceneView;
#endif
            }
            else if (antialiasing == PostProcessLayer.Antialiasing.FSR1)
            {
#if TND_FSR1
                return sgsr.UnityTAAEnabled && !isSceneView;
#endif
            ...
            return antialiasing == PostProcessLayer.Antialiasing.TemporalAntialiasing && !isSceneView;
        }
        ...
        public bool IsAASRActive()
        {
            return antialiasing == PostProcessLayer.Antialiasing.AASR
               && Application.isPlaying
               && !isSceneView;
        }
