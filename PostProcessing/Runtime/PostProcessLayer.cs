...
namespace UnityEngine.Rendering.PostProcessing
{
    ...
    public sealed class PostProcessLayer : MonoBehaviour
    {
        ...
        void OnRenderImage(RenderTexture src, RenderTexture dst)
        {
            ...
            if (!finalBlitToCameraTarget && (m_CurrentContext.IsFSR1Active() || m_CurrentContext.IsFSR3Active() || m_CurrentContext.IsDLSSActive()))
            {
#if AEG_FSR1
        ...
        void OnPreCull() {
            ...
            if(m_CurrentContext.IsTemporalAntialiasingActive() || m_CurrentContext.IsFSR1Active() || m_CurrentContext.IsFSR3Active() || m_CurrentContext.IsDLSSActive()) {
